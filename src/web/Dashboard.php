...
<li id="nav-param"><a href="param.php" onclick="changeColor('nav-param', 'param')" target="corps"><img id="param" src="icons/param.png" title="Paramètres" alt="Paramètres" height = "32px" width = "32px"/></a></li>
